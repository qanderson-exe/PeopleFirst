...
def forums_data():
    ...
    body = "Hi, I've been struggling a lot lately with coming home from classes and jumping straight into my job. It's been leaving me with little time to do any homework or studying " \
